...
APhysicsPickupBase::APhysicsPickupBase()
{
...
void APhysicsPickupBase::BeginPlay()
{
	Super::BeginPlay();
	...
	if (PickupCollider)
	{
		...
		PickupCollider->OnComponentBeginOverlap.AddDynamic(this, &APhysicsPickupBase::OnPickupOverlap);
	}
	else
	{
...
void APhysicsPickupBase::OnPickupOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
...
// Called every frame
void APhysicsPickupBase::Tick(float DeltaTime)
{
